...
export default function App() {
  ...
  const contacts = ['7739285002', '6201167980', '9031721575'];
  ...
  const handlePanic = async () => {
    ...
    Alert.alert("🚨 RAKSHA ALERT", `SMS to:\n${contacts.join('\n')}\n\nLocation:\n${link}`);
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={[styles.button, isHolding && styles.buttonActive]} onPressIn={startHold} onPressOut={cancelHold}>
...
const styles = StyleSheet.create({
  ...
  button: { width: 240, height: 240, borderRadius: 120, backgroundColor: '#ef4444', alignItems: 'center', justifyContent: 'center' },
